"""
AR Register Report Node
Copies generate_ar_invoice_register method from BrandedExcelGenerator
"""
...
@register_node
class ARRegisterReportNode(BaseTemplateNode):
    """
    AR Register Report Node
    Copies generate_ar_invoice_register method from BrandedExcelGenerator
    """
    
    name = "AR Register Report"
    category = "output"
    description = "Generates AR Register report by copying BrandedExcelGenerator functionality"
    ...
    def generate_ar_invoice_register(self, report_data: Dict[str, Any], company_id: str) -> str:
        """
        ...
        logger.info(f"AR Register Excel generated: {filepath}")
        return str(filepath)
    
    def run(self, input_data: Any, params: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate AR Register report by copying BrandedExcelGenerator functionality
        ...
        file_path = self.generate_ar_invoice_register(input_data, company_id)
        
        self.logger.info(f"Generated AR Register report: {file_path}")
